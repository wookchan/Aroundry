...
public class HwDTO {
	...
	int machine,storeid,f_cctv,f_game,f_toilet,f_concent,f_wifi,f_coin;
	  ...
	  public HwDTO(String titlelocation, String location, String imgpath, String ownerid, int machine, int storeid, int f_cctv, int f_game, int f_toilet, int f_concent, int f_wifi, int f_coin) {
	...
	public HwDTO(String titlelocation, String location, String imgpath, String conven, int machine) {
		super();
		this.titlelocation = titlelocation;
		this.location = location;
		this.imgpath = imgpath;
	...
	public HwDTO(String titlelocation, String location, String imgpath, String conven, String ownerid, int machine,	int storeid) {
		super();
		this.titlelocation = titlelocation;
		this.location = location;
		this.imgpath = imgpath;
