...
public class MoneyChargeInsert extends AsyncTask<Void, Void, String> {
    private static final String TAG = "main:MoneyChargeInsert";

    // 우리는 무조건 생성자를 만들어서 데이터를 넘겨받는다
    String userid, money;
    String state = "";

    public MoneyChargeInsert(String userid, String money) {
        this.userid = userid;
        this.money = money;
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            builder.addTextBody("money", money, ContentType.create("Multipart/related", "UTF-8"));

            Log.d(TAG, "하이염: "+ userid + "," + money);
...
//            }
            ...
            String postURL = ipConfig + "/laundry/moneycharge";
