...
public class MainWashSelect extends AsyncTask<Void, Void, Void> {
    private static final String TAG = "main:MainWashSelect";
    ...
    public MainWashSelect(ArrayList<MainWashDTO> dtos, MainWashAdapter adapter, String storeid) {
        this.dtos = dtos;
