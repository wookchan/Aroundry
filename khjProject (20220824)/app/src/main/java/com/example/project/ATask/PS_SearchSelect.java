...
public class PS_SearchSelect extends AsyncTask<Void, Void, Void> {
    ...
    public PS_SearchSelect(ArrayList<StoreDTO> dtos, PS_SearchAdapter adapter) {
        this.dtos = dtos;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/laundry/anSearch";
