...
public class MainMyWashSelect extends AsyncTask<Void, Void, Void> {
    ...
    public MainMyWashSelect(ArrayList<MainMyWashDTO> dtos, MainWashMyAdapter adapter, String userid) {
        this.dtos = dtos;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/laundry/mainwashmy";
    ...
    private MainMyWashDTO readMessage(JsonReader reader) throws IOException {
        ...
        return new MainMyWashDTO(userid, machineseq, resttime, machineid, storeid, address, location);
    }
