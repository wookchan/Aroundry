...
public class MonthTask extends AsyncTask<Void,Void,Void> {
    ArrayList<HW_CashDTO> dtos;
    Context context;
    HW_Home homeActivity;
    String userid;

    private static final String TAG = "MonthTask : ";
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
    SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy/MM/dd 00:00:00");

    public MonthTask(ArrayList<HW_CashDTO> dtos,String userid) {
        this.userid = userid;
        this.dtos = dtos;
    }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig+"/laundry/Hwmonthcost";
